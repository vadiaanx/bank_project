...
def test_get_mask_card_number_groups(card_number):
...
@pytest.mark.parametrize("bad_value", ["1234567812345", "12345678123456789", 123414124, "1234 5678 1234 5678",
                                       "12345678abcd5678", "", None, 0])

def test_get_mask_card_number_value_error(bad_value):
...
def test_get_mask_account_number_groups(account_number):
...
@pytest.mark.parametrize("bad_value", ["1234567812345", "12345678123456789", 123414124, "1234 5678 1234 5678",
                                       "12345678abcd5678", "", None, 0, "-12345678901234567890"])

def test_get_mask_account_number_value_error(bad_value):
