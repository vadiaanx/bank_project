...
@pytest.mark.parametrize("raw, expected",
    ...
    ("Счет 00123456000000007890", "Счет **7890"), ("Счет 12345678901234567890", "Счет **7890"),
...
@pytest.mark.parametrize("raw, expected", [("2024-03-11T02:26:18.671407", "11.03.2024"),
    ...
    ("2024-03-11T02:26:18Z",           "11.03.2024")]) # 'Z' (UTC)
